...
reported to the project maintainers by opening an issue, or — where the report
concerns sensitive matters — through a
[private security advisory](https://github.com/ciaranwhiteside/PatchManager/security/advisories/new)
so it is only visible to the maintainers. All complaints will be reviewed and
