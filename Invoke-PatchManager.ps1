...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .hero-panel{align-self:stretch;display:grid;align-content:end;gap:14px}.meta-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.meta-item,.hero-proof{border:1px solid rgba(255,255,255,.13);background:rgba(255,255,255,.055);border-radius:8px;padding:12px;box-shadow:inset 0 1px 0 rgba(255,255,255,.08)}.meta-item span,.hero-proof span{display:block;color:#a8b9b1;font-size:.75rem;font-weight:700;letter-spacing:0}.meta-item strong,.hero-proof strong{display:block;margin-top:3px;font-size:1rem;color:#fff}.hero-proof strong{line-height:1.25}
